<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ form: 'login', showLoginPassword: false, showRegisterPassword: false, showRegisterPasswordConfirmation: false, splashVisible: true, isMobile: window.innerWidth < 768 }" @resize.window="isMobile = window.innerWidth < 768" class="h-full">
<head>
    <meta charset="utf-8"/>
